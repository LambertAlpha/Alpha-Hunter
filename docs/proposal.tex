...
\begin{center}
\begin{tabular}{|c|p{3.9in}|p{1.8in}|}
\hline
\textbf{Stage} & \textbf{Task} & \textbf{Date Range} \\
\hline
1 & Kick-off meeting, finalize scope, align data sources, and begin drafting the Problem Statement and Literature Review sections. & November 10, 2024 -- November 11, 2024 \\
\hline
2 & Data acquisition, cleaning routines, validation of CSI~500 characteristic definitions, and completion of the Problem Statement and Literature Review drafts. & November 12, 2024 -- November 17, 2024 \\
\hline
3 & Implement winsorization, z-score normalization, optional size/industry neutralization, and rolling PCA feature store generation. & November 18, 2024 -- November 27, 2024 \\
\hline
4 & Develop Transformer and baseline models, conduct hyperparameter tuning, and generate preliminary out-of-sample forecasts. & November 28, 2024 -- December 4, 2024 \\
\hline
5 & Portfolio back-testing, robustness diagnostics, interpretability analysis, and preparation of presentation slides. & December 5, 2024 -- December 8, 2024 \\
\hline
6 & Refine documentation, integrate reviewer feedback, and finalize the written report. & December 9, 2024 -- December 15, 2024 \\
\hline
\end{tabular}
\end{center}
