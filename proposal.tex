...
The empirical analysis will focus on CSI 500 constituents to represent medium-sized A-share firms. We will align all variables on a monthly calendar, forward-fill accounting items to avoid look-ahead bias, and remove stocks with less than 24 months of history.
